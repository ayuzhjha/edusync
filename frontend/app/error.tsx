...
export default function Error({
  ...
  return (
    <div className="min-h-screen bg-muted/50 flex items-center justify-center px-4">
      <Card className="w-full max-w-md p-8 text-center bg-card shadow-xl border-t-4 border-destructive">
        ...
        {(!isChunkError || !isOffline) && error.message && (
          <p className="text-xs text-muted-foreground/80 mb-6 bg-muted/50 p-3 rounded font-mono break-all line-clamp-2">
            {error.message}
          </p>
        )}
